...
public class BackupA2 extends Algo{ // Replace TeamName
    private static String teamName = "BackupA2"; // Replace TeamName
    ...
    public static void main(String[] args){
        ...
        game.startGame(BackupA2.class); // Replace TeamName
    }
